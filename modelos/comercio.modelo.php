...
class ModeloComercio{
        ...
        static public function mdlActualizarInformacion($tabla, $id, $datos){
                ...
                $stmt = Conexion::conectar()->prepare("UPDATE $tabla SET impuesto = :impuesto, recojertienda = :recojertienda,
                ...
                $stmt->bindParam(":recojertienda", $datos["recojertienda"], PDO::PARAM_STR);
